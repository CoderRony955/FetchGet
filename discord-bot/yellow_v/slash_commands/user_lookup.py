...
class UserLookupCog(commands.Cog):
    def __init__(self, bot: commands.Bot):
        self.bot = bot

    @app_commands.command(name='find', description='Perform username lookup on over 20+ social networks.')
    async def find_user(self, interaction: discord.Interaction, username: str):
