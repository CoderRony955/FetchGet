...
class PutCog(commands.Cog):
    ...
    @app_commands.command(name='put', description='Mmake PUT requests by using valid URL and providing data to send via PUT request')
